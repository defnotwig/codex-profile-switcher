...
def print_logo():
    logo_lines = [
        r"      .-----.         ____   ___  ____  _____ __  __     ____  __      __  ___  _____  ____   _   _  _____  ____  ",
        r"   .-'       `-.     / ___| / _ \|  _ \| ____|\ \/ /    / ___| \ \ /\ / / |_ _|  |_   _|/ ___| | | | || |___ |  _ \ ",
        r" _(   \ >  ___  )_  | |    | | | | | | ||  _|   \  /     \___ \  \ V  V /   | |     | |  | |    | |_| ||  _|  | |_) |",
        r"(     / > |___|   ) | |___ | |_| | |_| || |___ /  \      ___) |  \  /\  /   | |     | |  | |___ |  _  || |___ |  _ < ",
        r" `-.___________.-'   \____| \___/|____/|_____|/_/\_\    |____/    \/  \/   |___|    |_|   \____||_| |_||_____||_| \_\ "
    ]
    for line in logo_lines:
        cloud = line[:21]
        title = line[21:]
        print(COLOR_PURPLE + cloud + COLOR_LIGHT_BLUE + title + COLOR_RESET)
    print(f"{' ' * 83}{COLOR_GREEN}[ Developed by @defnotwig ]{COLOR_RESET}\n")
